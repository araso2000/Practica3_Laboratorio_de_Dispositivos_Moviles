...
public class Assets {
    ...
    //NUEVO
    public static Musica melodia1;
    public static Musica melodia2;
    public static Musica melodia3;

    public static Pixmap botonMelodia1;
    public static Pixmap botonMelodia2;
    public static Pixmap botonMelodia3;

    public static Pixmap boton1x;
    public static Pixmap boton2x;
}